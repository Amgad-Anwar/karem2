            ...
            <div class="row justify-content-center">
                <div class="col-md-7 col-lg-8">
                    <div class="hero-content-wrap text-white text-center position-relative">
                        <h1 style="font-family: 'Frutiger LT Std', sans-serif !important;" class="text-white">القياس ومؤشرات الأداء</h1>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-12 col-lg-12">
                    <div class="card single-promo-card single-promo-hover text-center p-2 mt-4">
                        <div class="card-body">
                            ...
                            <div class="pt-2 pb-3">
                                <h5 style="font-family: 'Frutiger LT Std', sans-serif !important;">القياس ومؤشرات الأداء </h5>
                                <p class="mb-0"> يقوم فريق الخبراء والمستشـــارين بـ ( UPI ) بتوفير خدمات إدارة القياس ومؤشرات الأداء  للمؤسسات والبرامج الأكاديمية من خلال بناء تحالف استراتيجي مع المؤسسة / البرنامج يشمل بناء دليل متكامل لمؤشرات الأداء بمختلف باقاتها الاستراتيجية ( الرؤية 2030 / مؤشرات المؤسسة العليا / مؤشرات الخطة الاستراتيجية للمؤسسة / مؤشرات أداء الوحدات التابعة ) ، وتوفير منصة إلكترونية لتوفير حقيبة متكاملة من استطلاعات الرأي الجاهزة والمحكمة  والتقارير الإحصائية والتقارير الفصلية والسنوية لمؤشرات الأداء  .  </p>
                            </div>
                        </div>
                    </div>
                </div>
