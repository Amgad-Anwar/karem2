            ...
            <div class="row justify-content-center">
                <div class="col-md-7 col-lg-8">
                    <div class="hero-content-wrap text-white text-center position-relative">
                        <h1 style="font-family: 'Frutiger LT Std', sans-serif !important;" class="text-white">التخطيط الاستراتيجي  </h1>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-12 col-lg-12">
                    <div class="card single-promo-card single-promo-hover text-center p-2 mt-4">
                        <div class="card-body">
                            ...
                            <div class="pt-2 pb-3">
                                <h5 style="font-family: 'Frutiger LT Std', sans-serif !important;">التخطيط الاستراتيجي </h5>
                                <p class="mb-0">يقوم فريق الخبراء والمستشـــارين بـ UPI بتوفير خدمات التخطيط الاستراتيجي للمؤسسات من خلال بناء تحالف استراتيجي مع المؤسسة يشمل إعداد الخطة الاستراتيجية بالنموذج الأمثل للمؤسسة من نماذج التخطيط الاستراتيجي العالمية حسب طبيعة نشاط المؤسسة وحجمها وأهدافها. </p>
                            </div>
                        </div>
                    </div>
                </div>
