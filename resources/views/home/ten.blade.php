            ...
            <div class="row justify-content-center">
                <div class="col-md-7 col-lg-8">
                    <div class="hero-content-wrap text-white text-center position-relative">
                        <h1 style="font-family: 'Frutiger LT Std', sans-serif !important;" class="text-white">أحدث بروتوكولات التعاون والمشاركة في اعتماد الشهادات الاحترافية  </h1>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card single-promo-card single-promo-hover text-center p-2 mt-4">
                        <div class="card-body">
                            ...
                            <div class="pt-2 pb-3">
                                <h5 style="font-family: 'Frutiger LT Std', sans-serif !important;">نقابة التجاريين </h5>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="card single-promo-card single-promo-hover text-center p-2 mt-4">
                        <div class="card-body">
                            ...
                            <div class="pt-2 pb-3">
                                <h5 style="font-family: 'Frutiger LT Std', sans-serif !important;">نقابة المهن العلمية  </h5>
                            </div>
                        </div>
                    </div>
                </div>
