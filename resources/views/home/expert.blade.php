            ...
            <div class="row justify-content-center">
                <div class="col-md-7 col-lg-8">
                    <div class="hero-content-wrap text-white text-center position-relative">
                        <h1 style="font-family: 'Frutiger LT Std', sans-serif !important;" class="text-white">مجلس الخبراء </h1>
                        <p style="font-family: 'Frutiger LT Std', sans-serif !important;" class="lead">هى لجان علمية ومهنية مختصة ببناء بنوك الأسئلة وتصميم بطاقات الملاحظة للاختبارات العملية والمعملية التخصصية .
	تتشكل لجان المقيمون بقرار من المدير التنفيذي . 
 </p>
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-md-12 col-lg-6">
                    <div class="feature-contents section-heading">
                        <h2 style="font-family: 'Frutiger LT Std', sans-serif !important;">مهام المجلس  </h2>

                        <ul style="font-family: 'Frutiger LT Std', sans-serif !important;font-size:20px" class="check-list-wrap py-3">
                            <li>	بناء بنوك الأسئلة وفقا للاختبارات الالكترونية والمعملية   </li>
                            <li>	الاستجابة لتقارير تحكيم بنوك الأسئلة وطرق التقويم العملية وغير المباشرة من المجلس الاستشاري </li>
                            <li>	اجراء الاختبارات التحصيلية الالكترونية </li>
                            <li>	التحقق من هوية المتقدمين للاختبارات </li>
                            <li>	التحقق من استيفاء المتقدمين للاختبارات من المتطلبات السابقة</li>
                            <li>	اجراء الاختبارات العملية والمعملية وفقا لطبيعة الشهادة الاحترافية  </li>
                            <li>	تسجيل الدرجات والتحقق من اجتياز الممتحنين للاختبارات </li>
                            <li>	التوصية بالمنح / الإعادة </li>
                        </ul>
                    </div>
                </div>
