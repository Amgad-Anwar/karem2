            ...
            <div class="row justify-content-center">
                <div class="col-md-7 col-lg-8">
                    <div class="hero-content-wrap text-white text-center position-relative">
                        <h1 style="font-family: 'Frutiger LT Std', sans-serif !important;" class="text-white">المجالس الاستشارية الدولية </h1>
                        <p style="font-family: 'Frutiger LT Std', sans-serif !important;" class="lead">هي عبارة عن مجموعة من المجالس الاستشارية التخصصية في الشهادات الاحترافية ويتكون كل مجلس من مجموعة من العلماء والاكاديمين المتخصصين والخبراء وممثلي الهيئات والمنظمات ومؤسسات سوق العمل ذات الصلة بالشهادة الاحترافية . </p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-md-12 col-lg-6">
                    <div class="feature-contents section-heading">
                        ...
                        <ul style="font-family: 'Frutiger LT Std', sans-serif !important;" class="check-list-wrap list-two-col py-3">
                            <li>اجراء المقارنات والدراسات المرجعية  الدولية والوطنية. </li>
                            <li>متابعة وتحليل النتائج الخاصة بتقييم الاسكيم  وتقديم المقترحات التطويرية  </li>
                            <li>متابعة نتائج الاستبيانات الخاصة بنسبة رضا الجهات المستفيدة من  الحاصلين علي الشهادات الاحترافية وتقديم مقترحات تطويرية </li>
                            <li>دراسة المهارات والكفاءات المستهدفة للشهادات الاحترافية </li>
                            <li>تصميم المهارات والكفاءات المستهدفة </li>
                            <li>إعداد المقارنة المرجعية الداخلية والخارجية </li>
                            <li>بناء خريطة التقدير الكمي </li>
                            <li>التحسين المستمر للكفاءات والمهارات بناء على التطور في الكفاءات الوظيفية في سوق العمل وجهات التوظيف </li>
                            <li>التوصية  بالاسكيم  الخاص بالشهادة الاحترافية</li>
                            <li>التواصل مع مؤسسات العمل وجهات التوظيف والخريجون لبناء الكفاءات والمهارات المستهدفة </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-6 col-sm-12">
                    <div class="single-partner-wrap card-bottom-line bg-white border rounded text-center p-4 mt-4">
                        <div class="partner-heading mb-2">
                            <h5 style="font-family: 'Frutiger LT Std', sans-serif !important;" class="mb-0">المجلس الاستشاري للشهادات الاحترافية في نظم المعلومات الجغرافي</h5>
                        </div>
                        <div class="partner-info">
                            <p>هو المجلس المختص بتصميم الشهادات الاحترافية في مجال نظم المعلومات الجغرافية ومتابعة ضمان جودة عمليات التقييم المختلفة لدعم اعمال المطابقة وتقديم الدعم العلمي والمهني لفريق المقيمين .</p>
                            <a href="international-advisary-board-team.html" class="view-details-link"> 	أعضاء المجلس الاستشاري <span class="ti-angle-right"></span></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-6">
