                                    ...
                                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                        <div class="profile-tabs d-flex justify-content-between flex-wrap mt-1 mt-md-0">
                                            <ul class="nav nav-pills mb-0">
                                                <li class="nav-item">
                                                    <a class="nav-link fw-bold active" href="{{ route('user.profile') }}">
                                                        <span class="d-none d-md-block">{{__('translation.info')}}</span>
                                                        <i data-feather="rss" class="d-block d-md-none"></i>
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link fw-bold" href="{{ route('user.profile.setting') }}">
                ...
                <section id="profile-info">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-12 order-2 order-lg-1">
                                    ...
                                    <div class="card-body py-2 my-25">
                                        ...
                                        <form class="validate-form mt-2 pt-50">
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-sm-6 mb-1">
                                                    <label class="form-label" for="accountPassword">{{__('translation.phone')}}</label>
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <button type="reset" class="btn btn-outline-secondary mt-1">{{__('translation.discard')}}</button>
                                                </div>
                                            </div>
                                        </form>
                                        <!--/ form -->
                            ...
                            <div class="card">
                                <div class="card-header border-bottom">
                                    <h4 class="card-title">{{__('translation.delete_account')}}</h4>
                                </div>
                                <div class="card-body py-2 my-25">
                                    <div class="alert alert-warning">
                                        <h4 class="alert-heading">{{__('translation.alert_confirm_delete_account')}}</h4>
                                        <div class="alert-body fw-normal">
                                           {{__('translation.alert_delete_account')}}
                                        </div>
                                    </div>

                                    <form id="formAccountDeactivation" method="post" action="{{ route('user.profile.delete') }}" class="validate-form" onsubmit="return false">
                                        @csrf
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label font-small-3" for="accountActivation">
                                                {{__('translation.confirm_delete_account')}}
                                            </label>
                                        </div>
                                        <div>
                                            <button type="submit" class="btn btn-danger deactivate-account mt-1">{{__('translation.delete_account')}}</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
