            ...
            <div class="row justify-content-center">
                <div class="col-md-7 col-lg-8">
                    <div class="hero-content-wrap text-white text-center position-relative">
                        <h1 style="font-family: 'Frutiger LT Std', sans-serif !important;" class="text-white">التأهيل للحصول على شهادة التوافق مع متطلبات المواصفة القياسية العالمية الأيزو  . </h1>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-12 col-lg-12">
                    <div class="card single-promo-card single-promo-hover text-center p-2 mt-4">
                        <div class="card-body">
                            ...
                            <div class="pt-2 pb-3">
                                <h5 style="font-family: 'Frutiger LT Std', sans-serif !important;">التأهيل للحصول على شهادة التوافق مع متطلبات المواصفة القياسية العالمية الأيزو  . </h5>
                                <p class="mb-0">يقوم مجموعة من الخبراء بـ ( UPI  ) باستيفاء متطلبات التوافق مع متطلبات المواصفة القياسية العالمية الأيزوبجميع موصفاتها ، وهى تتضمن مجموعة من المعايير ضمن نظام إدارة الجودة، ومقاييس الايزو تصدرها وتحتفظ بها "المنظمة الدولية لتوحيد المقاييس " International Organization for Standardization،  وتقوم بإدارتها "مصلحة الاعتماد والتصديق" المختصة في الدول المختلفة.
                                                ويتم اعتماد المؤسسة من أعلى جهات الاعتماد العالمية من الولايات المتحدة الأمريكية وبريطانيا. </p>
                            </div>
                        </div>
                    </div>
                </div>
