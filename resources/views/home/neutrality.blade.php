...
<div class="main">
    ...
    <section style="min-height:400px" class="hero-slider-section bg-image hero-equal-height ptb-120 dark-bg" data-overlay="8">
        <div class="background-image-wraper" style="background: url('{{ asset('asset/home') }}/img/h1.jpg'); opacity: 1;"></div>
        <div class="">
            <div class="item">
                <div class="container">
                    <div class="row align-items-center">
                        <div style="text-align:center" class="col-md-12 col-lg-12">
                            <div class="hero-content-wrap text-white position-relative z-index ">
                                <h1 style="font-family: 'Frutiger LT Std', sans-serif !important;" class="text-white">مجلس الحيادية</h1>
                                <span style="font-family: 'Frutiger LT Std', sans-serif !important;font-size:24px" class="text-white h5 font-weight-norma">هى لجنة مستقلة تختص بالبت في الشكاوى والتظلمات الخاصة بأعمال التقييم وجميع قراراته نهائية ولا يجوز الطعن عليها.</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12 col-lg-6">
                    <div class="feature-contents section-heading">
                        ...
                        <ul style="font-family: 'Frutiger LT Std', sans-serif !important;font-size:20px" class="check-list-wrap py-3">
                            <li>يتشكل المجلس بقرار من مجلس المعهد العالمي للمحترفين ويتألف من :</li>
                            <li>عدد 3 استشاريين من الجهات الأكاديمية في كل اسكيم</li>
                        </ul>
                    </div>
                </div>
