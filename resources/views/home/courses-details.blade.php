                ...
                <div class="row align-items-center justify-content-between">
                    <div class="col-md-7 col-lg-6">
                        <div class="cta-content-wrap text-white">
                            <h2 style="font-family: 'Frutiger LT Std', sans-serif !important;" class="text-white">وصف الكورس </h2>
                            <p style="font-family: 'Frutiger LT Std', sans-serif !important;">{!! $certificate->description !!}</p>
                        ...
                        <div class="action-btns mt-4">
                            ...
                            <form method="POST" action="{{ route('user.enroll') }}">
                                ...
                                <button style="font-family: 'Frutiger LT Std', sans-serif !important;" type="submit" class="btn btn-brand-03"> حجز الكورس </button>
                            </form>
                        </div>
                    </div>
                    <div class="col-md-5 col-lg-4">
                        <div class="cta-img-wrap text-center">
                            <img src="{{ asset('asset/home') }}/img/server-room.svg" class="img-fluid" alt="server room">
                        </div>
                    </div>
                </div>
            </div>
